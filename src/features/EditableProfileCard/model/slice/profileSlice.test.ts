...
describe('profileSlice.test', () => {
    ...
    test('test clear Data', () => {
        ...
        expect(
            editProfileReducer(state as EditableProfileSchema, editProfileActions.clearData()),
        ).toEqual({
            data: undefined,
            error: undefined,
            form: undefined,
    ...
    test('test update profile service pending', () => {
        ...
        expect(
            editProfileReducer(
                state as EditableProfileSchema,
                updateProfileData.pending('1', undefined),
            ),
        ).toEqual({
            isLoading: true,
    ...
    test('test update profile service fullfiled', () => {
        ...
        expect(
            editProfileReducer(
                state as EditableProfileSchema,
                updateProfileData.fulfilled(validData, '1', undefined),
            ),
        ).toEqual({
            isLoading: false,
            validateErrors: undefined,
