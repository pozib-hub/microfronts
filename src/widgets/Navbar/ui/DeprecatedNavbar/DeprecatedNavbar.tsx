...
import style from './DeprecatedNavbar.module.scss'

interface INavbarProps {
    className?: string
}

export const DeprecatedNavbar: FC<INavbarProps> = memo(function DeprecatedNavbar(props) {
                    ...
                    <Menu
                        ...
                        trigger={
                            <div className={style.avatar}>
                                ...
                                <span className={style.username}>{authData.username}</span>
                            </div>
                        }
        ...
        <header className={cn(style.navbar, className)}>
            <div className={style.links}>
                ...
                <Button variant="transparent" onClick={onOpenModal}>
                    <Text color="primary">{t('navbar.items.signIn')}</Text>
                </Button>
            </div>
            <LoginModal
